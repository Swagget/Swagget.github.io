...
Current Work
======
I'm currently working on combinatorial multi-armed bandits with monotonic aggregation functions. Traditional bandit algorithms assume linear reward structures, but real-world decision-making—from personalized recommendations to healthcare treatment selection—often involves complex, non-linear aggregations.
...
Background
------
Before joining UIC's PhD program (originally as an MS student, later transferred), I earned my undergraduate degree from Manipal University Jaipur (2015-2019), where I developed foundational skills in machine learning and systems. I've also worked in various machine learning roles in the industry before choosing to focus on the research aspect of ML.
...
I believe the future of AI lies in systems that are not just powerful, but interpretable, efficient, and theoretically grounded. Whether it's understanding the convex structure underlying neural network training or designing RL agents that plan with limited compute, I'm passionate about research that connects elegant mathematical theory with real-world impact.

When I'm not breaking my head on some math or reading papers, you'll find me playing the piano, cooking, or running.
