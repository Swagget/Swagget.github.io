...
* August 2021 - Present: PhD Student
  ...
  * Location: Chicago
  * Duties included: Partially studied masters here, and transferred to the PhD program. Currently pursuing a PhD here. Research projects include: Deblurring Computer Vision, Value smoothing using similarity-based on latent embeddings
...
* May 2023 - August 2023: Data Science Intern
  ...
  * Supervisor: Will Wilson, Ashutosh Singh
...
* November 2019 - March 2021: Deep Learning Engineer
  ...
  * Location: Bangalore
  * Duties included: Created an intelligent shopping cart to make checkout obsolete. Developed software to identify grocery products through computer vision. Projects include: Detecting when products are put into a cart, Webscraping for Grocery App, Automated data analysis, Colour based item selection, Created a Visual image Text-based search engine, Created a cropping tool
  * Supervisor: Maurice
